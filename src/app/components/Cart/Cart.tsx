...
const sampleItems: ClothingItem[] = [
  {
    ...
    type: "shirt",
    image:
      "https://res.cloudinary.com/dybipmq9j/image/upload/e_background_removal/f_png/v1745577908/download_rtzakx.jpg",
  },
  {
    id: "2",
    name: "Blue Jeans",
    type: "pant",
    image:
      "https://res.cloudinary.com/dybipmq9j/image/upload/e_background_removal/f_png/v1745577958/images_tc4ryn.jpg",
  },
  {
    id: "3",
    name: "Sneakers",
    type: "shoes",
    image:
      "https://res.cloudinary.com/dybipmq9j/image/upload/e_background_removal/f_png/v1745578005/download_bfu0xr.png",
  },
  {
    id: "4",
    name: "Black Jacket",
    type: "jacket",
    image:
      "https://res.cloudinary.com/dybipmq9j/image/upload/e_background_removal/f_png/v1745578086/download_2_fkellx.png",
  },
  {
    id: "5",
    ...
    type: "onepiece",
    image:
      "https://res.cloudinary.com/dybipmq9j/image/upload/e_background_removal/f_png/v1745578141/download_3_dxrobm.png",
  },
  {
    id: "6",
    name: "Baseball Cap",
    type: "hat",
    image:
      "https://res.cloudinary.com/dybipmq9j/image/upload/e_background_removal/f_png/v1745578193/download_4_cmztae.png",
  },
];
        ...
        <div className="mt-8 flex justify-between items-center">
          ...
          <div>
            <button
              ...
              className="bg-green-600 hover:bg-green-500 px-6 py-2 rounded text-white font-medium mr-4"
            >
              Add to Cart
            </button>
            <Link href="/cart">
              <button className="bg-blue-600 hover:bg-blue-500 px-6 py-2 rounded text-white font-medium">
                View Cart
              </button>
            </Link>
          </div>
